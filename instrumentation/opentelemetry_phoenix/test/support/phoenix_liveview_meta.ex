defmodule PhoenixLiveViewMeta do
  ...
  def component_render_stop() do
    component_render_start()
  end

  def component_render_exception() do
    Map.merge(component_render_start(), %{
      kind: :error,
      reason: %{message: "render error", __struct__: RuntimeError, __exception__: true},
      stacktrace: [
        {NnnnnWeb.MyTestLive.MyLiveComponent, :render, 1,
         [file: ~c"lib/nnnnn_web/live/my_live_component.ex", line: 20]}
      ]
    })
  end
