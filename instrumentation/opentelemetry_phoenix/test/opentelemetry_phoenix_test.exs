defmodule OpentelemetryPhoenixTest do
  ...
  test "records spans for Phoenix controller render" do
    ...
    meta = %{view: DemoWeb.PageView, template: "index", format: "html"}
    ...
    assert_receive {:span,
                    span(
                      name: "DemoWeb.PageView#index.html",
                      attributes: attributes
                    )}
  ...
  test "does not record controller render spans when controller: false" do
