defmodule OpentelemetryBaggageProcessor.MixProject do
  use Mix.Project
  ...
  def project do
    ...
    [
      ...
      name: "Opentelemetry BaggageProcessor",
      source_url:
        "https://github.com/open-telemetry/opentelemetry-erlang-contrib/tree/main/processors/opentelemetry_baggage_processor",
      docs: [
        markdown_processor: ExDoc.Markdown.Earmark,
        main: "OpentelemetryBaggageProcessor",
  ...
  defp package() do
    [
      description: "Library that defines a Span Processor which takes attributes from the Baggage and insert into the Span as attributes",
  ...
  defp load_app do
    {:ok, [{:application, name, desc}]} = :file.consult('src/opentelemetry_baggage_processor.app.src')
